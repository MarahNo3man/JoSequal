        ...
        <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <div class="px-lg-2">
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="http://localhost/phpmyadmin/index.php"
                                    target="_blank">
                                    <img src="{{ asset('backend/assets/images/brands/mysql.png') }}" alt="MySQL">
                                    <span>MySQL</span>
                                </a>
                            </div>
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ asset("backend\assets\images\about_img.png") }}"
                        alt="Header Avatar">
